    ...
    <div class="card card-success">
        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-6">
                    <div class="form-group row">
                        <label for="inputEmail3" class="col-sm-4 col-form-label"> teléfono del Técnico encargado: </label>
                        <div class="col-sm-8">
        ...
        <div class="card-body">
            <div class="container">
                ...
                <div class="row ">
                    <div class="col-12 col-sm-6">
                        <div class="col-12">
                            <img src="{{asset($equipo->imagen)}}" class="img-fluid" alt="Product Image" style="width: 400px; height: 400px;">
                        </div>
                    </div>
                    <div class="col-12 col-sm-6">
                        <h4>Nombre : <small>{{$equipo->nombre}}</small></h4>
                                    ...
                                    <div class="row">
                                        <div class="form-group">
                                            ...
                                            <div class="custom-control custom-checkbox">
                                                ...
                                                <label for="customCheckbox2" class="custom-control-label">limpieza interna
                                                    equipo</label>
                                            </div>
                                            <div class="custom-control custom-checkbox">
                                            ...
                                            <div class="custom-control custom-checkbox">
                                                ...
                                                <label for="customCheckbox6" class="custom-control-label">Verifi. general
                                                    estructura</label>
                                            </div>
                                            <div class="custom-control custom-checkbox">
                                            ...
                                            <div class="custom-control custom-checkbox">
                                                ...
                                                <label for="customCheckbox25" class="custom-control-label">Limpieza general
                                                    equipo</label>
                                            </div>
                                            <div class="custom-control custom-checkbox">
